...
//    Captures the 24-bit partial sum (PSOUT) every time the selected DIMC's
...
// 24-bit psum (PSOUT):         selected macro → out_fifo (auto-push on READYN=0)
//
// ============================================================
// DIAGNOSTIC OUTPUTS
// ============================================================
...
module dimc_dual #(
    ...
    // =========================================================================
    // Output FIFO — captures 24-bit psum (PSOUT) automatically when READYN goes low
    // =========================================================================
    ...
    always_comb begin
        ...
        // out_push: push the 24-bit PSOUT into the output FIFO whenever READYN is low.
